 ...
 * </p>
 */
public class MyRecursiveParserWrapper implements Parser {
     ...
     */
    public MyRecursiveParserWrapper(Parser wrappedParser, ContentHandlerFactory contentHandlerFactory) {
     ...
     */
    public MyRecursiveParserWrapper(Parser wrappedParser,
    ...
    public void parse(InputStream stream, ContentHandler ignore,
        ...
        String startingPath = context.get(RecursiveRoot.class, RecursiveRoot.DEFAULT).getPath();
        EmbeddedParserDecorator decorator = new EmbeddedParserDecorator(startingPath);
