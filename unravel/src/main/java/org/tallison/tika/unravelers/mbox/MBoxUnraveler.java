 ...
 */
public class MBoxUnraveler extends AbstractUnraveler {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MBoxUnraveler.class);
    ...
    public MBoxUnraveler(Parser parser, ContentHandlerFactory contentHandlerFactory, PostParseHandler postParseHandler) {
